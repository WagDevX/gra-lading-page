  ...
  return (
    <div class="grid w-full">
      ...
      <button
        ...
        class="text-white bg-primary hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-full text-sm w-full sm:w-auto px-6 py-3 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
      >
        Adicionar item
      </button>
          ...
          <tbody>
            ...
            <tr className="bg-blue-600">
              <th
                colSpan={3}
                scope="row"
                class="px-6 py-4 font-extrabold text-xl text-center text-white whitespace-nowrap dark:text-white"
              >
                TOTAL
              </th>
      ...
      <ReactToPrint
        trigger={() => (
          <button className="mt-5 text-white bg-primary hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-full text-sm w-full sm:w-auto px-6 py-3 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
            Imprimir
          </button>
        )}
